...
;---------------------interrupt vector------------------------------------------
 ...
 isr:
    btfsc ((INTCON) and 07Fh), 0 ;Se revisa si la bandera que registra un cambio está apag.
    call int_intonch ;Se llama la subrutina de interrupción del puerto B
    btfsc ((INTCON) and 07Fh), 2 ;Se revisa si la bandera de overflow de TMR0 esta enc.
...
int_intonch:
    ...
    bcf ((INTCON) and 07Fh), 0 ; Se pone en 0 la bandera que registra cambio en B
    return
...
config_int_enable:
    ...
    bcf ((INTCON) and 07Fh), 2 ; Se habilita la interrupción cuando la bandera del TMR0
