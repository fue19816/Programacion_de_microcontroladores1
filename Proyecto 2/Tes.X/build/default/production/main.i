...
void __attribute__((picinterrupt(("")))) Interrupciones(void){
    if (PIR1bits.ADIF == 1){
        ...
        if (ADCON0bits.CHS == 0){
            ...
            CCPR1L = (valor_pot3>>1) + 128;


            CCP1CONbits.DC1B1 = valor_pot3 & 0b01;
            ...
            CCPR2L = (valor_pot4>>1) + 128;


            CCP2CONbits.DC2B1 = valor_pot4 & 0b01;
...
void main(void) {
    ...
    while(1){
        ...
        dato_mem1 = readFromEEPROM(0x10);
        dato_mem2 = readFromEEPROM(0x11);
        dato_mem3 = readFromEEPROM(0x12);
        dato_mem3l = readFromEEPROM(0x13);
        dato_mem4 = readFromEEPROM(0x14);
        dato_mem4l = readFromEEPROM(0x15);

        PORTD = dato_mem1;

        if (RB0 == 1 && RB0_old == 0){
            writeToEEPROM(valor_pot1, 0x10);
            writeToEEPROM(valor_pot2, 0x11);
            writeToEEPROM(valor_pot3, 0x12);
            writeToEEPROM(valor_pot3l, 0x13);
            writeToEEPROM(valor_pot4, 0x14);
            writeToEEPROM(valor_pot4l, 0x15);
        }
